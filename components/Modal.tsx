...
const Modal = ({isOpen, onChange, title, description, children}: Props) => {
  return (
   ...
   <Dialog.Portal>
    ...
    />
    <Dialog.Content 
    className='fixed drop-shadow-md border border-neutral-700 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]
    max-h-full h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md:max-w-[450px] rounded-md bg-neutral-800 p-[25px]
    focus:outline-none'>
